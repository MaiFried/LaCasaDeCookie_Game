...
<head runat="server">
    <title>La Casa De Cookie - Error</title>
    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description" content="La Casa De Cookie" />
    <meta name="keywords" content="חג המולד, אפייה, משחק, משחק לימודי, למידה, איש לחם זנגביל" />
    <meta name="author" content="מאי פריד ודולי גוטיה" />
...
<body>
    ...
    <form id="errorForm" runat="server" class="container">

        <div style="text-align: center; margin-top: 20px">
            <asp:Label ID="errorPageLbl" runat="server" Text="אופס, קרתה שגיאה :(" Style="font-size: 22px; font-weight: 600;"></asp:Label>
            <br />
            <br />
            <h2 style="margin-bottom: 0px; font-size: 18px; position: relative; left: 34px;">מה יכול לגרום לזה?</h2>
            <br />
            <ul style="text-align: right; display: inline-grid;">
                <li>העלאת קבצים גדולים למדי</li>
                <li>עריכת 2 או יותר משחקים במקביל</li>
                <li>התחברות במקביל ממחשבים שונים</li>
            </ul>
            <br />
            <br />
            <asp:Button ID="backFromErrorBtn" runat="server" Text="בחזרה למשחקים שלי" CssClass="button " OnClick="backFromErrorBtn_Click" />
        </div>
    </form>
</body>
</html>
