<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sessionTimeout.aspx.cs" Inherits="timeout" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>La Casa De Cookie - Timeout</title>
    <meta charset="utf-8" />
...
<body class="snowCoverBg">
    ...
    <form id="timeoutForm" runat="server" class="container">

        <div id="timeoutDiv">

            <h2>יותר מדי זמן עבר ללא פעולה</h2>
            <p>יש להתחבר מחדש לאתר כדי להמשיך לערוך את המשחקים</p>
            <br />
            <asp:Button ID="loginBtnTimeout" runat="server" Text="לכניסה מחדש" CssClass="button" OnClick="LoginBtnTimeout_Click" />
